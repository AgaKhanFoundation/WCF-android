...
public class DateStringTypeConverter implements JsonDeserializer<Date>, JsonSerializer<Date> {
    ...
    public JsonElement serialize(Date src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        return src == null ? null : new JsonPrimitive(formatter.format(src.getTime()));
    }
