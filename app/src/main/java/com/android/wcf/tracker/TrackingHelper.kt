...
object TrackingHelper {
    ...
    var FITBIT_TRACKING_SOURCE_ID = 1 //TODO should be lookup value from list of Sources API
    var GOOGLE_FIT_TRACKING_SOURCE_ID = 2 //TODO should be lookup value from list of Sources API
